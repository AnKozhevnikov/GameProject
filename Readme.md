...
## Manager
Штука, которая хранит в себе сам класс игры и умеет вызывать его методы
...
NewEventListener - абстрактный класс, чьи наследники хранят в себе всю необходимую информацию о генерации нового EventListener. Обязательными полями являются:
...
В наследуемых от NewEventListenerInfo вы можете хранить любые поля, которые, как вам кажется, будут необходимы для порождения нового EventListener
