...
### Cell
1) ```std::string roomtype``` - тип комнаты(нет комнаты, коридор, комната)
...
Биндер не умеет вешать одну функцию на разные кнопки одновременно, а также на одну кнопку много функций, это грустно, но вам нахер не надо.
